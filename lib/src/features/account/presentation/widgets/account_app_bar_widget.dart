...
class AccountAppBarWidget extends StatefulWidget {
  const AccountAppBarWidget({super.key});

  @override
  State<AccountAppBarWidget> createState() => _AccountAppBarWidgetState();
}

class _AccountAppBarWidgetState extends State<AccountAppBarWidget> {
  @override
